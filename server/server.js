...
agent.intent('Default Welcome Intent', (conv) => {
  if(conv.user.last.seen) {      //First time user's
    ...
    conv.ask(
      '<speak>' + 
      'Your video  <emphasis level="moderate">  "Title of the Video" </emphasis> has got :- <break time="200ms"/> <br>' + 
      '10,000 Views <break time="300ms"/> <br>' + 
      '5,000 Likes <break time="300ms"/> <br>' + 
      '2,000 Comments <break time="300ms"/> and <br>' + 
      '50 Dislikes. <break time="500ms"/> <br>' + 
