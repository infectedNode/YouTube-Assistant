...
const helpIntent = (conv) => {
    ...
    conv.ask('<speak> "Channel Expert" is a Google Assistant app. Where I provide latest updates <break time="200ms" /> about your YouTube channel <break time="300ms" /> or about your last video uploaded.  \nYou may say Channel Reports or Video Reports for the same, respectively. </speak>');
    if(!payload) {
